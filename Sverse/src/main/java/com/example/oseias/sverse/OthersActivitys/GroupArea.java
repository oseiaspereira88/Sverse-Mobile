...
public class GroupArea extends AppCompatActivity implements RecyclerViewOnClickListenerHack {
    ...
    public void findFabs(){
        ...
        fab.setOnMenuToggleListener(new FloatingActionMenu.OnMenuToggleListener() {
            ...
            public void onMenuToggle(boolean opened) {
                //Toast.makeText(GroupArea.this, "Is menu Opened: " + (opened? "true" : "false"), Toast.LENGTH_SHORT).show();
            }
        });
