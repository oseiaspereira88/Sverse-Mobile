...
import com.example.oseias.sverse.OtherAdapters.ConcluidosObjetivoAdapter;
...
public class ConcluidosObjetivoFragment extends Fragment implements ConcluidosRecyclerViewOnClickListenerHack {
    private RecyclerView rv;
    ConcluidosObjetivoAdapter adapter;
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View rootView = inflater.inflate(R.layout.fragment_concluidos_objetivo, null); //->container, false
    ...
    public void initializeViews(ViewGroup container, View rootView) {
        ...
        areaExcluir.setOnDragListener(new ConcluidosObjetivoAdapter.MyOnDragListener());
        ...
        rv.setOnScrollListener(new RecyclerView.OnScrollListener() {
            ...
            public void onScrolled(RecyclerView recyclerView, int dx, int dy) {
                ...
                adapter = (ConcluidosObjetivoAdapter) rv.getAdapter();
        ...
        adapter = new ConcluidosObjetivoAdapter(getActivity(), generateItens());
