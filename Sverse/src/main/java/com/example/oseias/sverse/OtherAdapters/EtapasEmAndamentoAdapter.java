...
public class EtapasEmAndamentoAdapter extends RecyclerView.Adapter<EtapasEmAndamentoAdapter.MyViewHolder> {
    ...
    public EtapasEmAndamentoAdapter(Context ctx, ArrayList<Etapa> etapas) {
        this.ctx = ctx;
        this.etapas = etapas;
        ...
        public MyViewHolder(View itemView) {
            ...
            itemView.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    if(recyclerViewOnClickListenerHack != null){
                        recyclerViewOnClickListenerHack.onClickListener2(v, getPosition());
                    }
                }
            });
            ...
            itemView.setOnLongClickListener(new View.OnLongClickListener() {
                ...
                public boolean onLongClick(View v) {
                    if(recyclerViewOnClickListenerHack != null){
                        recyclerViewOnClickListenerHack.onLongClickListener2(v, getPosition());
                    }
                    return true;
                }
            });
    ...
    public static class MyOnDragListener implements View.OnDragListener{
        ...
        public boolean onDrag(View v, DragEvent event) {
            if(recyclerViewOnClickListenerHack != null){
                recyclerViewOnClickListenerHack.onDragListener2(v, event);
            }
            return true;
        }
    }
