...
public class EmAndamentoObjetivoAdapter extends RecyclerView.Adapter<EmAndamentoObjetivoAdapter.MyViewHolder> {
    private Context ctx;
    ...
    public EmAndamentoObjetivoAdapter(Context ctx, ArrayList<Objetivo> objetivos) {
        this.ctx = ctx;
